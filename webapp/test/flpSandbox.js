		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "CentiMark Roofing Solution",
									"targetURL": "#poccentimarkcentimarkui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"poccentimarkcentimarkui-display": {
								"semanticObject": "poccentimarkcentimarkui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=poc.centi.mark.centimarkui",
									"url": sap.ui.require.toUrl("poc/centi/mark/centimarkui")
								}
							}
						}
					}
